...
public class Utilities {
    ...
    public static void removeUiObserver(Object uiObserver, ArrayList<?> uiObserversList) {
        // remove the observer if it was already added here
        try {
            ArrayList<Object> uiObservers = new ArrayList<>(uiObserversList);
     ...
     *errorDialog
     */
    public static void showTryAgainDialog(final Activity activity, String title, String msg, DialogInterface.OnClickListener action) {
        ...
        builder.setMessage(msg)
                .setCancelable(true)
                .setPositiveButton("Try Again", action)
...
//		int dp = (int) (BaseApplication.getContext().getResources().getDimension(resId) / BaseApplication.getContext().getResources().getDisplayMetrics().density);
        return BaseApplication.getContext().getResources().getDimensionPixelSize(resId);
